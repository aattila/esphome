...
> **Note**: This is a fork of the official ESPHome repository. The original can be found at [esphome/esphome](https://github.com/esphome/esphome).
...
![Solar PV Display Example](solar-pv.png)
